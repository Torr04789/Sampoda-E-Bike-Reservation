...
$eid=intval($_GET['eid']);
$status=1;
$sql = "UPDATE ebikecontactusquery SET status=:status WHERE  id=:eid";
...
<head>
	...
	<title>E-Bike Rental Reservation System |Admin Manage Queries   </title>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT * from  ebikecontactusquery ";
$query = $dbh -> prepare($sql);
$query->execute();
