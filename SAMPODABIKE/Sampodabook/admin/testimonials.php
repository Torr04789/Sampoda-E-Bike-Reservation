...
$eid=intval($_GET['eid']);
$status="0";
$sql = "UPDATE ebiketestimonial SET status=:status WHERE  id=:eid";
...
$sql = "UPDATE ebiketestimonial SET status=:status WHERE  id=:aeid";
$query = $dbh->prepare($sql);
$query -> bindParam(':status',$status, PDO::PARAM_STR);
...
<head>
	...
	<title>E-Bike Rental Reservations |Admin Manage testimonials   </title>
						...
						<div class="panel panel-default">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT ebikeusers.FullName,ebiketestimonial.UserEmail,ebiketestimonial.Testimonial,ebiketestimonial.PostingDate,ebiketestimonial.status,ebiketestimonial.id from ebiketestimonial join ebikeusers on ebikeusers.Emailid=ebiketestimonial.UserEmail";
$query = $dbh -> prepare($sql);
$query->execute();
