...
$brand=$_POST['brand'];
$id=$_GET['id'];
$sql="update  ebikebrands set BrandName=:brand where id=:id";
...
<head>
	...
	<title>E-Bike Rental Reservation System | Admin Update Brand</title>
...
<?php	
$id=$_GET['id'];
$ret="select * from ebikebrands where id=:id";
