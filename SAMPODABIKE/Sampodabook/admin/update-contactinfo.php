...
$sql="update ebikecontactusinfo set Address=:address,EmailId=:email,ContactNo=:contactno";
...
<head>
	...
	<title>E-Bike Rental Reservations | Admin Create Brand</title>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<?php $sql = "SELECT * from  ebikecontactusinfo ";
$query = $dbh -> prepare($sql);
$query->execute();
