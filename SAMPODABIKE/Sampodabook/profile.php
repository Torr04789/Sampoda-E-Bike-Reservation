...
$sql="update ebikeusers set FullName=:name,ContactNo=:mobileno,dob=:dob,Address=:adress,City=:city,Country=:country where EmailId=:email";
...
<title>E-Bike Rental Reservation System | My Profile</title>
<!--Bootstrap -->
