...
$sql = "SELECT ebikevehicles.id from ebikevehicles 
join ebikebrands on ebikebrands.id=ebikevehicles.VehiclesBrand 
where ebikevehicles.VehiclesTitle=:search || ebikevehicles.FuelType=:search || ebikebrands.BrandName=:search || ebikevehicles.ModelYear=:search";
...
<?php 
$sql = "SELECT ebikevehicles.*,ebikebrands.BrandName,ebikebrands.id as bid  from ebikevehicles 
join ebikebrands on ebikebrands.id=ebikevehicles.VehiclesBrand 
where ebikevehicles.VehiclesTitle=:search || ebikevehicles.FuelType=:search || ebikebrands.BrandName=:search || ebikevehicles.ModelYear=:search";
$query = $dbh -> prepare($sql);
$query -> bindParam(':search',$searchdata, PDO::PARAM_STR);
