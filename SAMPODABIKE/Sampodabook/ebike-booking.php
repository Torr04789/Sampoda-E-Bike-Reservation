    ...
    <div class="row">
      <div class="col-md-9 col-md-push-3">
        <div class="result-sorting-wrapper">
          ...
          <?php 
// Query for Listing count for vehicles with FuelType 'Booking'
$sql = "SELECT id FROM ebikevehicles WHERE FuelType = 'Booking'";
...
<?php 
// Query to fetch vehicle details with FuelType 'Booking'
$sql = "SELECT ebikevehicles.*, ebikebrands.BrandName, ebikebrands.id as bid 
        ...
        WHERE ebikevehicles.FuelType = 'Booking'";
$query = $dbh->prepare($sql);
$query->execute();
$results = $query->fetchAll(PDO::FETCH_OBJ);
$cnt = 1;
...
<aside class="col-md-3 col-md-pull-9">
  ...
  <div class="sidebar_widget">
    ...
    <div class="recent_addedcars">
      ...
      <?php 
      // Fetch recently listed vehicles with FuelType 'Booking'
      $sql = "SELECT ebikevehicles.*, ebikebrands.BrandName, ebikebrands.id as bid 
              FROM ebikevehicles 
              JOIN ebikebrands ON ebikebrands.id = ebikevehicles.VehiclesBrand 
              WHERE ebikevehicles.FuelType = 'Booking' 
